...
object TagDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array(
                ...
                //   |     | | | | | | | |       |       |      |      |         | |         |     | | | | | | csr   | | amo
                //   |     | | | | | | | |       |       |      |      |         | |         |     | | | | | | |     | | |
    LDCHK0->    List(xpr64,N,N,N,N,N,N,Y,A2_IMM, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRD_T,  MT_T, N,N,N,N,N,Y,CSR.N,N,N,N),
    LDCHK1->    List(xpr64,N,N,N,N,N,N,Y,A2_IMM, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRD_T,  MT_T, N,N,N,N,N,Y,CSR.N,N,N,N),
    SDSET0->    List(xpr64,N,N,N,N,N,Y,Y,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWR_T,  MT_T, N,N,N,N,N,N,CSR.N,N,N,N),
    SDSET1->    List(xpr64,N,N,N,N,N,Y,Y,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWR_T,  MT_T, N,N,N,N,N,N,CSR.N,N,N,N),
    SDPRSV->    List(xpr64,N,N,N,N,N,Y,Y,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWP_T,  MT_T, N,N,N,N,N,N,CSR.N,N,N,N),
    MEMCPY->    List(xpr64,N,N,N,N,N,Y,Y,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XCP_T,  MT_T, N,N,N,N,N,N,CSR.N,N,N,N))
}
