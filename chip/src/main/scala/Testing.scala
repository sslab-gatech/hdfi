...
object DefaultTestSuites {
  ...
  val rv64uiNames = LinkedHashSet("addw", "addiw", "ld", "lwu", "sd", "slliw", "sllw", "sltiu", "sltu", "sraiw", "sraw", "srliw", "srlw", "subw", "dfi-allmatch", "dfi-mismatch")
  //val rv64uiNames = LinkedHashSet("dfi-allmatch", "dfi-mismatch")

  val rv64ui = new AssemblyTestSuite("rv64ui", "rv64ui", rv32uiNames ++ rv64uiNames)(_)
  //val rv64ui = new AssemblyTestSuite("rv64ui", "rv64ui",rv64uiNames)(_)
  ...
  //val rv64u = List(rv64ui)

  //val rv64i = List(rv64ui)
  ...
  val bmarks = new BenchmarkTestSuite("basic", "$(base_dir)/riscv-tools/riscv-tests/benchmarks", LinkedHashSet(
    "median", "multiply", "qsort", "towers", "vvadd", "mm", "dhrystone", "spmv", "mt-vvadd", "mt-matmul", "tagger-test", "memcpy-test"))
