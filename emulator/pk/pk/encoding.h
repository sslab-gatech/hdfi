...
#define MATCH_LDCHK1 0x1057
#define MASK_LDCHK1 0x707f
...
#define MATCH_SDSET1 0x3057
#define MASK_SDSET1 0x707f
...
#define CAUSE_TAGMISMATCH_LOAD 0xc
#endif
#ifdef DECLARE_INSN
...
DECLARE_INSN(ldchk1, MATCH_LDCHK1, MASK_LDCHK1)
...
DECLARE_INSN(sdset0, MATCH_SDSET0, MASK_SDSET0)
DECLARE_INSN(sdset1, MATCH_SDSET1, MASK_SDSET1)
...
DECLARE_CAUSE("tag mismatch load", CAUSE_TAGMISMATCH_LOAD)
#endif
